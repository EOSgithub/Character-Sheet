...
export const ORIGIN_FEATS: OriginFeatDef[] = [
  ...
  { key: 'crafter', name: 'Crafter', text: "Tool Proficiency: gain proficiency with three Artisan's Tools of your choice. Discount: 20% discount when buying nonmagical items. Fast Crafting: after a Long Rest, you can craft one piece of simple gear from a tool you're proficient with; it lasts until your next Long Rest." },
  ...
  { key: 'musician', name: 'Musician', text: 'Instrument Training: gain proficiency with three Musical Instruments of your choice. Encouraging Song: as you finish a Short or Long Rest, you can play a song to give Heroic Inspiration to allies (up to your Proficiency Bonus) who hear it.' },
  ...
  { key: 'skilled', name: 'Skilled', text: 'You gain proficiency in any combination of three skills or tools of your choice. Repeatable: you can take this feat more than once.' },
